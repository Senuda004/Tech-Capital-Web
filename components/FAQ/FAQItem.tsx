    ...
    <>
      <div className="flex flex-col border-b border-stroke last-of-type:border-none dark:border-strokedark">
        <button
          ...
          className="flex cursor-pointer items-center justify-between px-6 py-5 text-metatitle4 font-medium text-black dark:text-white lg:px-9 lg:py-7.5 text-left leading-8"
        >
          {quest}
        ...
        <p
          className={`border-t text-justify border-stroke px-6 py-5 dark:border-strokedark lg:px-9 lg:py-7.5 ${
